...
- [CMake 4.2][cmake_downloads] ([*release notes*][cmake_relnotes])
...
- [Cppcheck 2.18][cppcheck_downloads] ([*changelog*][cppcheck_changelog])
...
- [OrangeC 7.0][orangec_downloads] ([*release notes*][orangec_relnotes])
...
Tool versions:
   ...
   cmake 4.2.0, cl 19.36.33523, cppcheck 2.18.3, doxygen 1.15.0,
   msbuild 17.11.2.32701, git 2.52.0, diff 3.12, bash 5.2.37(1)
...
clangarm64/mingw-w64-clang-aarch64-cppcheck 2.18.3-1
    static analysis of C/C++ code (mingw-w64)
mingw64/mingw-w64-x86_64-cppcheck 2.18.3-1 [installed]
    static analysis of C/C++ code (mingw-w64)
ucrt64/mingw-w64-ucrt-x86_64-cppcheck 2.18.3-1
    static analysis of C/C++ code (mingw-w64)
clang64/mingw-w64-clang-x86_64-cppcheck 2.18.3-1
    static analysis of C/C++ code (mingw-w64)
&nbsp;
...
[...]
Packages (4) mintty-1~3.8.1-1  msys2-runtime-3.6.4-2  msys2-runtime-devel-3.6.4-2  pacman-6.1.0-19

Total Download Size:   15.67 MiB
Total Installed Size:  81.08 MiB
Net Upgrade Size:       3.93 MiB
...
<a href="https://cmake.org/download/">cmake-4.2.0-windows-x86_64.zip</a>                  <i>( 38 MB)</i>
...
<a href="https://github.com/LADSoft/OrangeC/releases">ZippedBinaries707.zip</a> (OrangeC)                 <i>( 22 MB)</i>
</pre>
</dd></dl>
...
[bazel_downloads]: https://github.com/bazelbuild/bazel/releases/tag/8.4.2
...
8.1.0 -> https://github.com/bazelbuild/bazel/releases/tag/8.1.0
8.1.1 -> https://github.com/bazelbuild/bazel/releases/tag/8.1.1
8.2.0 -> https://github.com/bazelbuild/bazel/releases/tag/8.2.0
8.3.0 -> https://github.com/bazelbuild/bazel/releases/tag/8.3.0
8.4.0 -> https://github.com/bazelbuild/bazel/releases/tag/8.4.0
...
[cmake_relnotes]: https://cmake.org/cmake/help/v4.2/release/4.2.html
...
[orangec_relnotes]: https://github.com/LADSoft/OrangeC/releases/tag/v7.0.7
